...
/// </summary>
public class MarchRenderer : IBlockMeshGenerator {
  ...
  void march(Coordinate pointLocation) {
    ...
    // @TODO: re-impliment getting the sibling vertexes, probably move it to the loop below:
    byte blockMask                    = 0;//points.getBlock(pointLocation).GetBlockVertexMask();
